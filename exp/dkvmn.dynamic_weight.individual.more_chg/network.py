...
class DKVMNcell(nn.Module):
    def __init__(self, input_size, hidden_size, memory_size, dsize=8):
        ...
        self.stu_e = nn.Linear(hidden_size, hidden_size)
        self.stu_a = nn.Linear(hidden_size, hidden_size)
    ...
    def forward(self, x, memory, student):
        ...
        student = student * (1 - torch.sigmoid(self.stu_e(v)))
        student = student + torch.tanh(self.stu_a(v))
